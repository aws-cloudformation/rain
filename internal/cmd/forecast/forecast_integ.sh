...
create_result=$(./rain forecast test/templates/forecast-fail.yml forecast-integ)
...
update_result=$(./rain forecast test/templates/forecast-succeed.yml forecast-integ)
